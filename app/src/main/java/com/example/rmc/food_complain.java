...
public class food_complain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_complain);
    ...
    public void showImg(View view) {
        ...
        startActivity(new Intent(getApplicationContext(),show_food_image.class));
    }
    ...
    private void uploadDataToServer() {
        String UPLOAD_URL = "http://complaintormc.tonysolutions.co/food/insertdata.php";
